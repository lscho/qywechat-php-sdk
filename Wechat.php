<?php
namespace qywechat;
use qywechat\lib\WXBizMsgCrypt;
use qywechat\lib\ErrorCode;
use qywechat\lib\SHA1;
use qywechat\lib\XMLParse;
use qywechat\lib\PKCS7Encoder;
use qywechat\lib\Prpcrypt;
/**
 *	微信公众平台企业号SDK修订版
 *  @author  binsee <binsee@163.com>[revision by lscho]
 *  @link https://github.com/lscho/qywechat-php-sdk
 *  @version 1.0
 *  usage:
 *   $options = array(
...
class Wechat
{
	...
	public function __construct($options)
	{
		...
		if(empty($options['appid'])&&!empty($options['CorpID'])){
			$this->appid=$options['CorpID'];
		}
	}
